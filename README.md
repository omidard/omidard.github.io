...
| [Flux Studio](https://omidard.github.io/FluxStudio/) | A constraint-based modelling workbench: thirteen analyses, GLPK compiled to WebAssembly, solved in the browser with no server |
